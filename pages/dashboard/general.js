                ...
                <div className="sm:pt-8">
                        ...
                        <div className="lg:flex items-center lg:ml-12 justify-between ">
                            <div className="flex items-center ml-12 justify-between ">
                                <div className="avatar">
                                    {
                                        user?.photoURL && <div className="w-44 rounded-full">
                                ...
                                <div className="hero my-8 ml-4">
                                    <div className="hero-content">
                                        <div className="max-w-md">
                                            ...
                                            {profile && profile[0]?.phone && <p className="py-2"><strong>phone :</strong> {profile[0]?.phone}</p>}
                                            {profile && profile[0]?.socialLink && <p className="py-2"><strong>socialLink :</strong> {profile[0]?.socialLink}</p>}
                                            {profile && profile[0]?.street && <p className="py-2"><strong>street :</strong> {profile[0]?.street}</p>}
                                            {profile && profile[0]?.state && <p className="py-2"><strong>state :</strong>{profile[0]?.state}</p>}
                                            {profile && profile[0]?.country && <p className="py-2"><strong>country :</strong>{profile[0]?.country}</p>}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <Link href="#edit">
                                    <a className="my-4 hidden lg:block text-blue-400 text-bold text-xl mr-2  lg:mr-20 ">Edit</a>
                                </Link>
                                <button
                                    onClick={handleBack}
                    ...
                    <div className="bg-white lg:w-2/3 lg:rounded-l-lg mx-6 lg:mt-8 lg:mx-auto px-6 lg:px-20">
                        ...
                        <form onSubmit={handleEditInfo}
                            className="container max-w-[1080px] mx-auto" id="edit">
                            <div className="py-8">
                                ...
                                <div className="lg:flex mb-2 -mx-1">
                                    <div className="lg:w-1/2 mb-3 lg:mb-2 mx-1">
                                        <div className="px-1">
                                            <label className="text-gray-600 font-light">Phone</label>
                                            <input
                                                type="text"
                                                name="phone"
                                    ...
                                    <div className="lg:w-1/2  mb-3 lg:mb-2 mx-1">
                                        <div className="px-1">
                                            <label className="text-gray-600 font-light">Social Link</label>
                                            <input
                                                type="text"
                                                name="link"
                                                className="w-full mt-1 px-2 py-1 border rounded-lg text-gray-700 focus:outline-none focus:border-green-500"
