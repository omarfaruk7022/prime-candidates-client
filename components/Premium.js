  ...
  return (
	...
	<div className="container mx-auto p-4 sm:p-10">
		<div className="mb-16 space-y-4 text-center">
			<h1 className="text-4xl font-semibold leading-tight text-secondary">Pricing</h1>
		...
		<div className="grid max-w-md grid-cols-1 gap-6 mx-auto auto-rows-fr lg:max-w-full lg:gap-2 xl:gap-6 lg:grid-cols-3">
			<div className="relative z-0 flex flex-col items-center p-8 border rounded-md h-[500px]">
				<span className="absolute top-0 px-6 pt-1 pb-2 font-medium rounded-b-lg bg-secondary ">Personal</span>
				<p className="my-6 text-4xl font-bold text-secondary">FREE</p>
				...
				<button className="px-4 py-2 mt-4 font-semibold uppercase border rounded md:mt-12 sm:py-3 sm:px-8 border-secondary">Subscribe</button>
			</div>
			<div className="relative flex flex-col items-center p-8 border-2 rounded-md ">
				<span className="absolute top-0 px-6 pt-1 pb-2 font-medium rounded-b-lg bg-secondary">Professional</span>
				...
				<button className="px-8 py-3 mt-12 text-lg font-semibold uppercase rounded bg-secondary dark:text-gray-900">Subscribe</button>
			</div>
			<div className="relative z-0 flex flex-col items-center p-8 border rounded-md ">
				<span className="absolute top-0 px-6 pt-1 pb-2 font-medium rounded-b-lg bg-secondary">Enterprise</span>
				<p className="flex items-center justify-center my-6 space-x-2 font-bold">
