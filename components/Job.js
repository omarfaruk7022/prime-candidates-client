    ...
    return (
        <div className="card w-2/4 mx-auto my-5 bg-base-100 shadow-xl">
            <div className="card-body">
                ...
                <div className='flex '>
                    <p><span className='text-primary font-semibold'>Category:</span> {jobCategory}</p>
                    <p><span className='text-primary font-semibold'>Job Type:</span> {jobType}</p>
                    <p><span className='text-primary font-semibold'>Salary:</span> {salaryRange}</p>
                </div>
