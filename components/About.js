        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-12 lg:ml-12">
            <div>
                <div>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa distinctio placeat ducimus deleniti cumque quae error esse aliquam minus architecto?</p>
                    <p className='mt-4'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa distinctio placeat ducimus deleniti cumque quae error esse aliquam minus architecto?</p>
                </div>
                <div className='mt-8'>
                    <h3 className='text-2xl font-bold'>Why Choose Us</h3>
                    <hr className='w-12 border-[1px] border-[#262E3B] mb-2' />
                    <ul>
                        <li className='flex items-center'> <FaLongArrowAltRight className='mr-2' />Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, expedita?</li>
                        <li className='flex items-center'> <FaLongArrowAltRight className='mr-2' />Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, expedita?</li>
                        <li className='flex items-center'> <FaLongArrowAltRight className='mr-2' />Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, expedita?</li>
                    </ul>
                </div>
